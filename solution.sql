...
--SELECT * FROM "syntax_practice" WHERE account_balance = 0.00 AND transactions = 0
--UPDATE *account_balance 10.00;
...
SELECT username, account_balance FROM "syntax_practice" WHERE account_balance > 0 ORDER BY account_balance DESC LIMIT 3;
...
VALUES ('Ernie', 'manhattan', 3, 3, 9.000);
